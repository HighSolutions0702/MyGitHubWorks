        ...
        return {
            ...
            load: function (module, callback, locale) {
                ...
                modulesToLoad.forEach(function (modName, index, array) {
                    ...
                    ajaxFunction(fileUrl, function (text, status) {
                        if (status == 200) {
            ...
            /**
             * Resets the contained properties to defaults.
             */
            reset: function () {
                properties = ajaxFunction = fileNameResolver = filePath = null;
                fileExtension = DEFAULT_EXTENSION;
                currentLocale = defaultLocale = 'en_US';
                debugMode = validConfiguration = false;
            }
        };
