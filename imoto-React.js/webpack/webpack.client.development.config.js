...
configuration.module.loaders.push(
  { test: /\.js$/, exclude: /node_modules/, loader: "eslint-loader?quiet=true&fix=true" },
...
module.exports = universalWebpack.clientConfiguration(configuration, settings, { development: true, css_bundle: true })
